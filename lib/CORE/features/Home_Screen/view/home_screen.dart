      ...
      child: Column(
        children: [
          AppBarMain(
            ...
            secondIconName: 'plus',
            firstOnPressed: () {},
            secondOnPressed: () { push(context, const AddPostScreen());
            },
          ),
          SizedBox(
            height: 2.h,
          ...
          Expanded(
            child: ListView.builder(
              ...
              postSeen: '177',
              postTitle:
              'Flutter is Google’s mobile UI open source framework to build high-quality native (super fast) interfaces for iOS and Android apps with the unified codebase.', postLikeClickAction: () { }, postCommentClickAction: () {
              ...
              }, postSeenClickAction: () {  }, shareClickAction: () {  },
            ),itemCount: 7,),
          ),
        ],
      ),
