          ...
          children: [
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: AppButton(onPressed:() => AppSettings.openAppSettings(), label: 'Go To Settings', sizeFont: 16.sp,bgColor: AppColors.primary,borderRadius: BorderRadius.circular(14.sp)),
                )
              ],
            )
          ],
